  ...
  if (num_makefiles == 0)
    {
      static const char *default_makefiles[] =
        ...
        { WAKE_MAKEFILES "makefile.vms", "gnumakefile.", "makefile.", 0 };
#else
#ifdef _AMIGA
        { WAKE_MAKEFILES "GNUmakefile", "Makefile", "SMakefile", 0 };
#else /* !Amiga && !VMS */
#ifdef WINDOWS32
        { WAKE_MAKEFILES "GNUmakefile", "makefile", "Makefile", "makefile.mak", 0 };
#else /* !Amiga && !VMS && !WINDOWS32 */
        { WAKE_MAKEFILES "GNUmakefile", "makefile", "Makefile", 0 };
