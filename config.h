...
#define MAKE_HOST "x86_64-unknown-cygwin"
...
#define PACKAGE_NAME "wake (based on GNU make 4.1)"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "wake (based on GNU make 4.1)"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "wake"
